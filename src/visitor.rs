...
impl<A:ForIRI, V:Visit<A>> Walk<A, V> {
    ...
    pub fn axiom(&mut self, e:&Axiom<A>){
        ...
        match e {
            ...
            Axiom::InverseFunctionalObjectProperty(ax) => self.inverse_functional_object_property(ax),
            ...
            Axiom::NegativeObjectPropertyAssertion(ax) => self.negative_object_property_assertion(ax),
    ...
    pub fn literal(&mut self, e:&Literal<A>){
        ...
        match e {
            ...
            Literal::Datatype{literal:_, datatype_iri} => self.iri(datatype_iri),
        }
    }
    ...
    pub fn sub_object_property_expression(&mut self, e:&SubObjectPropertyExpression<A>){
        ...
        match e {
            SubObjectPropertyExpression::ObjectPropertyChain(e) => self.object_property_expression_vec(e),
            SubObjectPropertyExpression::ObjectPropertyExpression(e) => self.object_property_expression(e)
        }
    }
...
mod test {
    ...
    #[derive(Default)]
    struct IRIExtract(Vec<String>);
    impl Visit<String> for IRIExtract {
        fn visit_iri(&mut self, iri:&IRI<String>) {
            dbg!();
